...
#**************************Admin and HR**************************  
    ...
    path('admin_hr_depmt/<int:id>', views.admin_hr_depmt , name='admin_hr_depmt'),
   
    path('admin_allMembers_category/<int:pk>/<int:id>/',views.admin_allMembers_category , name='admin_allMembers_category'),
    path('admin_category_contactedlist/<int:pk>/<int:id>/',views.admin_category_contactedlist , name='admin_category_contactedlist'),
    ...
    path('admin_category_history/<int:pk>/<int:id>/',views.admin_category_history , name='admin_category_history'),
    path('admin_category_intrestedlist/<int:pk>/<int:id>/',views.admin_category_intrestedlist , name='admin_category_intrestedlist'),
    path('admin_category_newlist/<int:pk>/<int:id>',views.admin_category_newlist , name='admin_category_newlist'),
   
    path('admin_contactsave/',views.admin_contactsave , name='admin_contactsave'),
    path('admin_category_rejectedlist/<int:pk>/<int:id>/',views.admin_category_rejectedlist , name='admin_category_rejectedlist'),
    ...
    path('hr_allMembers_category/<int:id>/', views.hr_allMembers_category , name='hr_allMembers_category'),
    path('hr_category_newlist/<int:id>/', views.hr_category_newlist , name='hr_category_newlist'),
   
    path('hr_category_contactedlist/<int:pk>/', views.hr_category_contactedlist , name='hr_category_contactedlist'),
    path('hr_category_intrestedlist/<int:pk>/', views.hr_category_intrestedlist , name='hr_category_intrestedlist'),
    path('hr_category_rejectedlist/<int:pk>/', views.hr_category_rejectedlist, name='hr_category_rejectedlist'),
    path('hr_category_history/<int:pk>/', views.hr_category_history, name='hr_category_history'),
